					...
					<View style={dynamicStyles.section}>
						...
						<View style={dynamicStyles.proCard}>
							...
							<Text style={dynamicStyles.proCardDescription}>
								Unlock unrestricted tracking, unlimited meals,
								and premium reports. Start your 5-day free trial
								today!
							</Text>
							<View style={dynamicStyles.proFeatureList}>
								...
								<View style={{ flexDirection: 'row', gap: 12 }}>
									...
									>
										<View
											style={dynamicStyles.bestValueBadge}
										>
											<Text
												style={
													dynamicStyles.bestValueText
												}
											>
												BEST VALUE
											</Text>
